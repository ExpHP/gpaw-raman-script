...
def get_deperm_from_phonopy_sc_to_ase_sc(natoms, repeats):
    ...
    unitcell_lattice = np.eye() * natoms
    ...
    p_sc_positions = phonopy.Phonopy(p_atoms, supercell_matrix=np.diag(repeats)).get_positions()
    ...
    assert (a_sc_positions_int[deperm_ase_to_lexical] == p_sc_positions_int[deperm_phonopy_to_lexical])
